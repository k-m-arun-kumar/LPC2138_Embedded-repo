Description :
============
I just shared my works, which I worked as learning path and practiced Embedded C programming using LPC2138 (ARM7TDMI-S 32 bit RISC microcontroller by NXP (founded by Philips)) for interface of LED, 7 Segment LED, LED Dot Matrix, Switch, Keypad & LCD, UART, Timer, Interrupt. Other features are not implemented. 
...
my family, which helped me to recover my health. I again practiced and refresh C programming.
